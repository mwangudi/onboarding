					...
					if ($('#form').valid()) {
						...
						if (chosenvalue === "Yes" && settlements > 0) {
							...
							if (settlements === "2") {
								...
								$('#ConfirmOther').html($('#SettlementTable tr').find("td").eq(4).html());
								$('#ConfirmOthertr3').addClass('d_none');
								$('#ConfirmOthertr4').addClass('d_none');
								$('#ConfirmOthertr5').addClass('d_none');

								$('#SettlementAccount1').val($('#SettlementTable tr').find("td").eq(1).html());
								$('#InputCurrencyType1').val($('#SettlementTable tr').find("td").eq(2).html());
								$('#SettlementAccount2').val($('#SettlementTable tr').find("td").eq(4).html());
								$('#InputCurrencyType2').val($('#SettlementTable tr').find("td").eq(5).html());
							}
							else if (settlements === "3") {
								$('#ConfirmKES').html($('#SettlementTable tr').find("td").eq(1).html());
								$('#ConfirmOther').html($('#SettlementTable tr').find("td").eq(4).html());
								$('#ConfirmAccount3').html($('#SettlementTable tr').find("td").eq(7).html());
								$('#ConfirmOthertr4').addClass('d_none');
								$('#ConfirmOthertr5').addClass('d_none');

								$('#SettlementAccount1').val($('#SettlementTable tr').find("td").eq(1).html());
								$('#SettlementAccount2').val($('#SettlementTable tr').find("td").eq(4).html());
								$('#SettlementAccount3').val($('#SettlementTable tr').find("td").eq(7).html());

								$('#InputCurrencyType1').val($('#SettlementTable tr').find("td").eq(2).html());
								$('#InputCurrencyType2').val($('#SettlementTable tr').find("td").eq(5).html());
								$('#InputCurrencyType3').val($('#SettlementTable tr').find("td").eq(8).html());
							}
							else if (settlements === "4") {
								$('#ConfirmKES').html($('#SettlementTable tr').find("td").eq(1).html());
								$('#ConfirmOther').html($('#SettlementTable tr').find("td").eq(4).html());
								$('#ConfirmAccount3').html($('#SettlementTable tr').find("td").eq(7).html());
								$('#ConfirmAccount4').html($('#SettlementTable tr').find("td").eq(10).html());
								$('#ConfirmOthertr5').addClass('d_none');

								$('#SettlementAccount1').val($('#SettlementTable tr').find("td").eq(1).html());
								$('#SettlementAccount2').val($('#SettlementTable tr').find("td").eq(4).html());
								$('#SettlementAccount3').val($('#SettlementTable tr').find("td").eq(7).html());
								$('#SettlementAccount4').val($('#SettlementTable tr').find("td").eq(10).html());

								$('#InputCurrencyType1').val($('#SettlementTable tr').find("td").eq(2).html());
								$('#InputCurrencyType2').val($('#SettlementTable tr').find("td").eq(5).html());
								$('#InputCurrencyType3').val($('#SettlementTable tr').find("td").eq(8).html());
								$('#InputCurrencyType4').val($('#SettlementTable tr').find("td").eq(11).html());
							}
								...
								$('#ConfirmAccount3').html($('#SettlementTable tr').find("td").eq(7).html());
								$('#ConfirmAccount4').html($('#SettlementTable tr').find("td").eq(10).html());
								$('#ConfirmAccount5').html($('#SettlementTable tr').find("td").eq(13).html());

								$('#SettlementAccount1').val($('#SettlementTable tr').find("td").eq(1).html());
								$('#SettlementAccount2').val($('#SettlementTable tr').find("td").eq(4).html());
								$('#SettlementAccount3').val($('#SettlementTable tr').find("td").eq(7).html());
								$('#SettlementAccount4').val($('#SettlementTable tr').find("td").eq(10).html());
								$('#SettlementAccount5').val($('#SettlementTable tr').find("td").eq(13).html());

								$('#InputCurrencyType1').val($('#SettlementTable tr').find("td").eq(2).html());
								$('#InputCurrencyType2').val($('#SettlementTable tr').find("td").eq(5).html());
								$('#InputCurrencyType3').val($('#SettlementTable tr').find("td").eq(8).html());
								$('#InputCurrencyType4').val($('#SettlementTable tr').find("td").eq(11).html());
								$('#InputCurrencyType5').val($('#SettlementTable tr').find("td").eq(14).html());
							}
							else {
								$('#ConfirmKES').html($('#SettlementTable tr').find("td").eq(1).html());
							...
							$('#ConfirmKES').html('No Settlement Account').val();
						...
						if (signatories === "0") {
							...
							if (signatories === "1") {
								...
								$('#SignatoryDesignation1').val($('#SignatoriesTable tr').find("td").eq(1).html());
								$('#SignatoryPhoneNumber1').val($('#SignatoriesTable tr').find("td").eq(3).html());
							}
								...
								$('#SignatoryDesignation1').val($('#SignatoriesTable tr').find("td").eq(1).html());
								$('#SignatoryDesignation2').val($('#SignatoriesTable tr').find("td").eq(6).html());
								$('#SignatoryPhoneNumber1').val($('#SignatoriesTable tr').find("td").eq(3).html());
								$('#SignatoryPhoneNumber2').val($('#SignatoriesTable tr').find("td").eq(7).html());
							}
						...
						if (representatives === "0") {
							...
							if (representatives === "1") {
								...
								$('#UserEmail1').val($('#RepresentativesTable tr').find("td").eq(1).html());
							}
